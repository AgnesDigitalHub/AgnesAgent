...
def get_prompts_schema():
    ...
    tpl = a.Tpl()
    tpl.tpl("<div class='text-center py-8'><div class='text-6xl mb-4'>💬</div><div class='text-xl text-gray-500'>Prompt IDE 功能即将上线</div><div class='text-gray-400 mt-2'>编辑、测试和管理您的 Prompt</div></div>")
